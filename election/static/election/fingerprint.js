...
document.addEventListener('DOMContentLoaded', function () {
    // Attach fingerprint injection to any form that needs it:
    // verificationForm (voter login) and voteForm (ballot submission)
    ['verificationForm', 'voteForm'].forEach(function (formId) {
